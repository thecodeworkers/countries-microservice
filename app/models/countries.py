from mongoengine import Document, StringField, BooleanField, ListField, ReferenceField, IntField
...
class Countries(Document):
    ...
    code = StringField(min_length=2, max_length=2, required=True, unique=True)
